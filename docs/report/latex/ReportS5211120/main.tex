...
On Windows, the same command should be executed from Git Bash rather than assumed to work natively from \texttt{cmd.exe} or PowerShell, because the MAS launcher is currently validated through a Git-Bash-based execution path.
