...
The belief base also contains contextual information used during fusion. In particular, each event is associated with a population exposure class derived from WorldPop data, and with reference labels used for evaluation.
