...
+!assess_event(E, Requester) : flood_severity_path(E, Severity, ClaimLabel, EvidenceList, RuleLabel) <-
    ...
    .concat(Msg9, ".", Msg10);
    .custom.trace_line("WATER AGENT", Msg10);
    .send(Requester, tell, hazard_assessment(E, flood, Severity, ConclusionStatus, ConfidenceLevel, ClaimLabel, PrimaryCaveat, EvidenceList, CaveatList, RuleLabel)).
