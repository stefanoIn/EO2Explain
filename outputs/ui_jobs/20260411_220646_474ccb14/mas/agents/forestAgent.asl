...
+!assess_event(E, Requester) : fire_severity_path(E, Severity, ClaimLabel, EvidenceList, RuleLabel) <-
    ...
    .concat(Msg3, ", confidence=", Msg4);
    .concat(Msg4, ConfidenceLevel, Msg5);
    .concat(Msg5, ", claim=", Msg6);
    .concat(Msg6, ClaimLabel, Msg7);
    .concat(Msg7, ".", Msg8);
    .custom.trace_line("FOREST AGENT", Msg8);
...
fire_severity_path(E, mild, inconclusive_fire_signal, [], rule_inconclusive_fire_signal) :-
    not ndvi_damage_signal(E) &
